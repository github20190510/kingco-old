        ...
        <div id="cq9list">
            <!-- <section class="container-fluid text-center slot-nav-bar">
                ...
                <div class="input-group input-group-sm search-btn">
                    <input type="text" class="form-control bg-transparent" placeholder="{{ __('msg_zy_1.search'). __('msg_zy_1.game') }}" aria-label="Recipient's username" aria-describedby="button-addon2" v-model="search_word">
            ...
            <main role="main" class="container-fluid main slot-main">
                <div class="game-box d-flex flex-wrap align-content-start justify-content-center">
                    <div class="game flex-column enabled" v-for="(v, k) in gamedatas">
                        ...
                        <div class="gameImg"><!--<a :href="'/game/intogame/CQ9Game/' + v['gamecode']" target="_blank">--><img class="load"  alt="" :src="'{{asset('/css/')}}/' + MODEL_NAME + v['img']" @click="into_game('CQ9Game', v['gamecode'], '{{ __('msg_zy_1.click_into_game_button') }}', '{{ __('msg_zy_1.into_game') }}')"><!--</a>--></div>
