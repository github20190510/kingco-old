            ...
            <main role="main" class="container-fluid main slot-main">
                <div class="game-box d-flex flex-wrap align-content-start justify-content-center">
                    <div class="game flex-column enabled" v-for="(v, k) in gamedatas">
                        ...
                        <div class="gameImg"><!--<a :href="'/game/intogame/SAGame/' + v['gamecode']" target="_blank">--><img class="load"  alt="" :src="'{{asset('/css/')}}/' + MODEL_NAME + v['img']" @click="into_game('SAGame', v['gamecode'], '{{ __('msg_zy_1.click_into_game_button') }}', '{{ __('msg_zy_1.into_game') }}')"><!--</a>--></div>
