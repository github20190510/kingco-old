                                        ...
                                        <div  class="member-name">
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-if="{{$qrtype}} == 1">
                                                    {{ __('msg_zy_1.wechat') }}{{ __('msg_zy_1.qr_name') }} : @{{emp_qrcode.accountname}}
                                                ...
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-else>
                                                    {{ __('msg_zy_1.alipay') }}{{ __('msg_zy_1.qr_name') }} : @{{emp_qrcode.accountname}}
                                                    <button class="btn btn-secondary btn-sm" v-on:click="copy_to_clipboard(emp_qrcode.accountname)" style="float:right">
                                                         {{ __('msg_zy_1.copy_to_clipboard') }}
                                                    </button>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-if="{{$qrtype}} == 1">
                                                    {{ __('msg_zy_1.wechat') }}{{ __('msg_zy_1.qr_id') }} : @{{emp_qrcode.openningbank}}
                                                    <button class="btn btn-secondary btn-sm" v-on:click="copy_to_clipboard(emp_qrcode.openningbank)" style="float:right">
                                                         {{ __('msg_zy_1.copy_to_clipboard') }}
                                                    </button>
                                                </label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-else>
                                                    {{ __('msg_zy_1.alipay') }}{{ __('msg_zy_1.qr_id') }} : @{{emp_qrcode.openningbank}}
                                                    <button class="btn btn-secondary btn-sm" v-on:click="copy_to_clipboard(emp_qrcode.openningbank)" style="float:right">
                                                         {{ __('msg_zy_1.copy_to_clipboard') }}
                                                    </button>
                                                </label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">
                                                    {{ __('msg_zy_1.saving_amount') }} : @{{amount}}
                                                </label>
                                                
                                            </div>
                                            <!-- <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-if="{{$qrtype}} == 1">
                                                    {{ __('msg_zy_1.wechat') }}{{ __('msg_zy_1.qr_name') }}
                                                </label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-else>
                                                    {{ __('msg_zy_1.alipay') }}{{ __('msg_zy_1.qr_name') }}
                                                </label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-if="{{$qrtype}} == 1">{{ __('msg_zy_1.wechat') }}{{ __('msg_zy_1.qr_id') }}</label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" v-else>{{ __('msg_zy_1.alipay') }}{{ __('msg_zy_1.qr_id') }}</label>
                                                <div class="col-sm-9">
