        ...
        <main role="main" class="main container-fluid index-main" id="game_list">
            ...
            <section class="game-casino">
                ...
                <div class="collapse" id="collapseCasino">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                        ...
                        <li class="game-logo logo-sa" style="display:none" @click="trans_into_game('SAGame', 'SX')"></li>
                        ...
                        <li class="game-logo logo-n2" style="display:none" @click="trans_into_game('N2Live', 'SX')"></li>
                        <li class="game-logo logo-ibo" style="display:none" @click="trans_into_game('IBOGame', 'SX')"></li>
                        <li class="game-logo logo-wm" style="display:none" @click="trans_into_game('WMGame', 'SX')"></li>
                        <li class="game-logo logo-queenco" style="display:none" @click="trans_into_game('QueencoGame', 'SX')"></li>
                        <li class="game-logo logo-as" style="display:none" @click="trans_into_game('ASGame', 'SX')"></li>
                    </ul>
                </div>
            </section>
            <!--彩票-->
            <section class="game-lottery">
                ...
                <div class="collapse" id="collapseLottery">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                        <li class="game-logo logo-818" style="display:none" @click="trans_into_game('818Game', 'CP')"></li>
                        <li class="game-logo logo-bbin" style="display:none"></li>
                        <li class="game-logo logo-ky" style="display:none"></li>
                        <li class="game-logo logo-ig" style="display:none"></li>
                        <li class="game-logo logo-vr" style="display:none" @click="trans_into_game('VRGame', 'CP')"></li>
                        <li class="game-logo logo-lixin" style="display:none" @click="trans_into_game('LXGame', 'CP')"></li>
                        <li class="game-logo logo-sgwin" style="display:none" @click="trans_into_game('SGGame', 'CP')"></li>
                        <li class="game-logo logo-idc" style="display:none" @click="trans_into_game('IDCGame', 'CP')"></li>
                        <li class="game-logo logo-bg" @click="trans_into_game('BGGame', 'CP')"></li>
                    </ul>
                </div>
            </section>
            <!--電子-->
            <section class="game-slot">
                ...
                <div class="collapse" id="collapseSlot">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                        <li class="game-logo logo-cq9" style="display:none" @click="goto_game('comCQ9')"></li>
                        <li class="game-logo logo-pt" style="display:none"></li>
                        <li class="game-logo logo-ag" style="display:none"></li>
                        <li class="game-logo logo-bbin" style="display:none"></li>
                        <li class="game-logo logo-qt" style="display:none"></li>
                        <li class="game-logo logo-pg" style="display:none" @click="goto_game('comPG')"></li>
                        <li class="game-logo logo-ab" style="display:none"></li>
                        <li class="game-logo logo-sky" style="display:none" @click="goto_game('comSW')"></li>
                        <li class="game-logo logo-im" style="display:none"></li>
                        <li class="game-logo logo-mg" style="display:none"></li>
                        <li class="game-logo logo-yo" style="display:none"></li>
                        <li class="game-logo logo-mw" style="display:none" @click="goto_game('comMW')"></li>
                        <li class="game-logo logo-sg" style="display:none"></li>
                        <li class="game-logo logo-gns" style="display:none" @click="goto_game('comGenesis')"></li>
                        <li class="game-logo logo-sa" style="display:none" @click="goto_game('comSA')"></li>
                        <li class="game-logo logo-vt" style="display:none" @click="goto_game('comVT')"></li>
                        <li class="game-logo logo-rtg" style="display:none" @click="goto_game('comRTG')"></li>
                    </ul>
                </div>
            </section>
            <!--棋牌-->
            ...
            <section class="game-sport">
                ...
                <div class="collapse" id="collapseSport">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                        ...
                        <li class="game-logo logo-bl" style="display:none" @click="trans_into_game('BLinkGame', 'TY')"></li>
                        <li class="game-logo logo-ysb" style="display:none" @click="trans_into_game('YSBGame', 'TY')"></li>
                    </ul>
                </div>
            </section>
            <!--釣魚-->
            <section class="game-fishing">
                ...
                <div class="collapse" id="collapseFishing">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                        <li class="game-logo logo-sa" style="display:none" @click="trans_into_game('SAGame', 'FishermenGold')"></li>
                        <li class="game-logo logo-gg" style="display:none" @click="trans_into_game('TCGGGame', 'G00009')"></li>
                    </ul>
                </div>
            </section>
        ...
        var game_list = new Vue({
            ...
            methods: {
                ...
                trans_into_game: function(gid, gtype){
                    ...
                    this.into_game(gid, gtype, '{{ __('msg_zy_1.click_into_game_button') }}', '{{ __('msg_zy_1.into_game') }}');
