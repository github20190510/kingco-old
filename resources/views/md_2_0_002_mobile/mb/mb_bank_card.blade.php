        ...
        <div id="mb_bankcards">
            <main role="main" class="container main bank-main">
                <section class="d-flex flex-wrap justify-content-around">
                    <div class="add-card">
                        <button type="button" class="btn d-flex align-items-center flex-column justify-content-center" onclick="location.href='/mb/bank_card_add'"><i class="far fa-plus-square"></i>{{ __('msg_zy_1.add_bank_card_mobile') }}</button>
                    </div>
