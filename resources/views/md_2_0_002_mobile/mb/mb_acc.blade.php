                ...
                <section class="user-data-bar d-flex flex-row">
                    ...
                    <div class="user-data row flex-grow-1 justify-content-between">
                        <div class="col d-flex flex-column justify-content-between">
                            ...
                            <button type="button" class="btn btn-sm transfer-btn" @click="fast_get_money">{{ __('msg_zy_1.one_click_out') }}</button>
                        </div>
                ...
                <section class="mt-3">
                    <ul class="row d-flex flex-wrap justify-content-between" v-if="loading_game_finishing == 1">
                        <li class="platform c-alpha-gold ZBLIVE" v-for="(game,index) in games">
                            ...
                            <button type="button" class="btn text-white mx-0 login-btn" @click="fast_set_money(game.gametype,index)">{{ __('msg_zy_1.flash_in') }}</button>
                            <button type="button" class="btn text-white mx-0 login-btn" data-toggle="modal" data-target="#set_money" :data-stuff="[game.name,game.gametype]" @click="set_game_index(index)">{{ __('msg_zy_1.trans_in') }}</button>
                            <button type="button" class="btn text-white mx-0 login-btn" data-toggle="modal" data-target="#get_money" :data-stuff="[game.name,game.gametype]" @click="set_game_index(index)">{{ __('msg_zy_1.trans_out') }}</button>
                        </li>
                    </ul>
