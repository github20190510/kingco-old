                                    ...
                                    <div v-if="grepStatus == 1 " class="content" style="color:#FFF">
                                        <div v-for ="(emp_card, index) in emp_cards" class="member-name">
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" >{{ __('msg_dt_1.bank_name') }} : @{{emp_card.bankname}}
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left" >{{ __('msg_dt_1.acoount_name') }} : @{{emp_card.accountname}}
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left" >{{ __('msg_dt_1.bank_account') }} : @{{emp_card.openningaccount}}
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_dt_1.saving_amount') }} : @{{amount}}</label>
                                                
                                            </div>
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_dt_1.open_account_name') }}</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_dt_1.open_account') }}</label>
                                                <div class="col-sm-9">
