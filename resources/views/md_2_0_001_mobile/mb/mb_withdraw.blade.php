                ...
                <form class="needs-validation" novalidate onSubmit="return false;">
                    <section class="input-group register-input dropdown-box">
                        ...
                        <div class="input-group-append dropdown-right">
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="btn_bank">{{ __('msg_dt_1.select_bank_card') }}</button>
                    ...
                    <div class="input-group register-input">
                        ...
                        <input type="number" class="form-control border-left-0 bg-transparent" id="bankid" placeholder="{{ __('msg_dt_1.withdrawal') . __('msg_dt_1.amount') }} : {{ __('msg_dt_1.input_wd_amount') }}" required v-model="get_money">
                        <div class="invalid-feedback">
                                {{ __('msg_dt_1.input_wd_amount') }}
                        </div>
                    </div>
                    <div class="input-group register-input">
                        <div class="input-group-append">
                        ...
                        <input type="password" class="form-control border-left-0 bg-transparent" id="password" placeholder="{{ __('msg_dt_1.pay_pwd') }} : {{ __('msg_dt_1.input_pay_pass') }}" required v-model="pay_pwd">
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group register-input">
                        ...
                        <textarea class="form-control border-left-0 bg-transparent" id="msg" placeholder="{{ __('msg_dt_1.mb_comments') }} : {{ __('msg_dt_1.input_mb_comments') }}" v-model="pay_msg" aria-label="With textarea"></textarea>
                    </div>
                    <div v-if="bln_can_send == 0" style="color:red">{{ __('msg_dt_1.should_bet') }}：@{{int_should_money}} {{ __('msg_dt_1.already_bet') }}：@{{int_bet_money}}</div>
                ...
                get_money_account: function(){
                    ...
                    .then(function (response) {
                        ...
                        if(this.json['code'] == '1'){
                            ...
                            self.alertinfo('<?php echo __("msg_dt_1.waiting_review") ?>', '/mb/mb_index');
                            self.getbagmoney();
                        }else{
                            self.if_send_or_not = false;
