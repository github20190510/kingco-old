    ...
    <body class="main-body">
        ...
        <div id="show_records">
            <main role="main" class="container main bank-main">
                ...
                <section class="mb-2">
                    <div class="row">
                        <div class="col text-left"><i class="far fa-list-alt"></i> {{ __('msg_dt_1.total_count') }}: <strong class="text-warning">@{{ data_count }}</strong></div>
                        <div class="col text-right"><i class="fas fa-coins"></i> {{ __('msg_dt_1.total_money') }}: <strong class="text-warning">@{{ formatMoney(data_bet) }}</strong></div>
                    </div>
                </section>
