            ...
            <main role="main" class="container main bank-main">
                ...
                <section class="funds-table mb-3" v-if="bln_has_take_data == 1" v-for="takedata in takedatas">
                    ...
                    <div class="row funds-2">
                        <div class="col">{{ __('msg_dt_1.order_no') }} : <strong class="text-warning">@{{takedata.ordernumber}}</strong></div>
                    </div>
                    <div class="row funds-2">
                        <div class="col-6">{{ __('msg_dt_1.amount') }} : <strong class="text-warning">@{{ formatMoney(takedata.orderamount )}}</strong></div>
                        <div class="col-6">{{ __('msg_dt_1.status') }} : <span>@{{takedata.str_status}}</span></div>
                    </div>
                </section>
