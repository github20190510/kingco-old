...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
            ...
            <main role="main" class="container-fluid main slot-main">
                <div class="game-box d-flex flex-wrap align-content-start justify-content-center">
                    <div class="game flex-column enabled" v-for="(v, k) in gamedatas">
                        ...
                        <div class="gameImg"><!--<a :href="'/game/intogame/SAGame/' + v['gamecode']" target="_blank">--><img class="load"  alt="" :src="'{{asset('/css/')}}/' + MODEL_NAME + v['img']" @click="into_game('SAGame', v['gamecode'], '{{ __('msg_dt_1.click_into_game_button') }}', '{{ __('msg_dt_1.into_game') }}')"><!--</a>--></div>
        ...
        readTextFile('{{asset("js/games/sw_list.js")}}', function(text){

            json_data = JSON.parse(text);
            for_data = json_data['sw_game_data'];
            var app = new Vue({
                el : '#swlist',
                data : {
                    gamedatas : new Array(),                    
