                                ...
                                <div class="user-edit-module">
                                    <div class="msg-tab">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link d-flex align-items-center active" id="home-tab" data-toggle="tab" href="#home1" role="tab" aria-controls="home" aria-selected="true" @click="set_default(0)"><i class="far fa-credit-card fa-sm  mr-1"></i> {{ __('msg_zy_1.acc_change') . __('msg_zy_1.record') }}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link d-flex align-items-center" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false" @click="set_default(1)"><i class="fas fa-money-check-alt fa-sm mr-1"></i> {{ __('msg_zy_1.recharge') . __('msg_zy_1.record') }}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link d-flex align-items-center" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false" @click="set_default(2)"><i class="fas fa-hand-holding-usd fa-sm  mr-1"></i>{{ trans_choice('msg_zy_1.withdraw', 1) . __('msg_zy_1.record') }}</a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <div class="form-row my-2">
                                                        <div class="col-auto my-1">
                                                            <div class="ant-calendar-picker-input ant-input-sm">
                                                                <vue-datepicker-local v-model="range" placeholder="{{ __('msg_zy_1.start') . __('msg_zy_1.date') }}"  tabindex="-1" style="color:initial" @input="show_change_data" format="YYYY-MM-DD HH:mm:ss"></vue-datepicker-local>
                                                            </div>
                                                        </div>
                                                        <div class="col-auto my-1">
                                                            <label class="mr-sm-2 sr-only">{{ __('msg_zy_1.acc_change') . __('msg_zy_1.type') }}</label>
                                                            <select class="custom-select custom-select-sm mr-sm-2" v-model="ddlchangetype" @change="show_change_data">
                                                                <option value="nodata">{{ __('msg_zy_1.acc_change') . __('msg_zy_1.type') }}</option>
                                                                <option value="8D37FD20D92043FA8D856590F0DFED0F">{{ __('msg_zy_1.deposit') }}</option>
                                                                <option value="8CD5E45210A44F3287CF2C0D7C61703E">{{ trans_choice('msg_zy_1.withdraw', 1) }}</option>
                                                                <option value="AF0B2F04CCA64E3197F047402FEE5832">{{ __('msg_zy_1.game_points_up') }}</option>
                                                                <option value="2BC2CB7FDD7B4720906B56812E075F94">{{ __('msg_zy_1.game_points_down') }}</option>
                                                                <option value="D6B0C11A0AC44EBBB1538BE69B004811">{{ __('msg_zy_1.promotion') }}</option>
                                                                <option value="1A53AEC4179E4E46AEE7EE752C16E3B1">{{ __('msg_zy_1.set_positive') }}</option>
                                                                <option value="831F252CEAE94DD0A740260EE151A437">{{ __('msg_zy_1.set_negative') }}</option>
                                                            </select>
                                                        </div>                                                    
                                                    </div>
                                                    <div>
                                                        <div class="col-auto my-1 text-gold">
                                                            {{ __('msg_zy_1.single_page_money') }}：@{{change_page_total}}&nbsp;&nbsp;&nbsp;&nbsp;{{ __('msg_zy_1.total_count') }}：@{{change_total_count}}&nbsp;&nbsp;&nbsp;&nbsp;{{ __('msg_zy_1.total_money') }}：@{{change_total}}
                                                        </div>
                                                    </div>
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" class="text-left">{{ __('msg_zy_1.date') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.reason') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.acc_change') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.balance') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.detail') }}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                            ...
                                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                <div>
                                                    <div class="form-row my-2">
                                                        <div class="col-auto my-1">
                                                            <div class="ant-calendar-picker-input ant-input-sm">
                                                                <vue-datepicker-local v-model="range2" placeholder="{{ __('messate.start') . __('msg_zy_1.date') }}"  tabindex="-1" style="color:initial" @input="show_save_order" format="YYYY-MM-DD HH:mm:ss"></vue-datepicker-local>
                                                            </div>
                                                        </div>
                                                        <div class="col-auto my-1">
                                                            <label class="mr-sm-2 sr-only">{{ __('msg_zy_1.order') . __('msg_zy_1.status') }}</label>
                                                            <select class="custom-select custom-select-sm mr-sm-2" v-model="ddlsavetype" @change="show_save_order">
                                                                <option value="1">{{ __('msg_zy_1.processing') }}</option>
                                                                <option value="2">{{ __('msg_zy_1.processed') }}</option>
                                                                <option value="3">{{ __('msg_zy_1.turn_down') }}</option>
                                                                <option value="4">{{ __('msg_zy_1.refuse') }}</option>
                                                                <option value="5">{{ __('msg_zy_1.pending_payment') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <div class="col-auto my-1 text-gold">
                                                            {{ __('msg_zy_1.single_page_money') }}：@{{save_page_total}}&nbsp;&nbsp;&nbsp;&nbsp;{{ __('msg_zy_1.total_count') }}：@{{save_total_count}}&nbsp;&nbsp;&nbsp;&nbsp;{{ __('msg_zy_1.total_money') }}：@{{save_total}}
                                                        </div>
                                                    </div>
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" class="text-left">{{ __('msg_zy_1.date') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.order_no') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.amount') }}</th>
                                                                <th scope="col">{{ __('msg_zy_1.order') . __('msg_zy_1.remark') }}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                            ...
                                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                                <div>
                                                    <div class="form-row my-2">
                                                        <div class="col-auto my-1">
                                                            <div class="ant-calendar-picker-input ant-input-sm">
                                                                <vue-datepicker-local v-model="range3" placeholder="{{ __('msg_zy_1.start') . __('msg_zy_1.date') }}"  tabindex="-1" style="color:initial" @input="show_take_order()" format="YYYY-MM-DD HH:mm:ss"></vue-datepicker-local>
                                                            </div>
                                                        </div>
                                                        <div class="col-auto my-1">
                                                            <label class="mr-sm-2 sr-only">{{ __('msg_zy_1.order') . __('msg_zy_1.status') }}</label>
                                                    ...
                                                    <div>
                                                        <div class="col-auto my-1 text-gold">
                                                            {{ __('msg_zy_1.single_page_money') }}：@{{take_page_total}}&nbsp;&nbsp;&nbsp;&nbsp;{{ __('msg_zy_1.total_count') }}：@{{take_total_count}}&nbsp;&nbsp;&nbsp;&nbsp;{{ __('msg_zy_1.total_money') }}：@{{take_total}}
                                                        </div>
                                                    </div>
                                                    <table class="table table-hover">
                                                        <thead>
