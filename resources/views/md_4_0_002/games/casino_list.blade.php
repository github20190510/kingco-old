    ...
    <body>
        ...
        <div class="main casino-content-module">
            <div class="content" id="casino_game">
                <div class="casinoNav">
                    <li class="">{{ __('msg_zy_1.OG') }}(OG)</li>
                    <li class="">{{ __('msg_zy_1.AB') }}(AB)</li>
                    <li class="">{{ __('msg_zy_1.AG') }}(AG)</li>
                    <li class="">{{ __('msg_zy_1.BBIN') }}(BBIN)</li>
                </div>
                <a :href="game_href" target="_blank" ref="gamelink"></a>
                <ul class="d-flex flex-wrap justify-content-between">
                    <li id="c-dg" class="c-dg" :class="{disabled : dg_active == 0, enabled : dg_active == 1}" >
                        <!--@click="into_game('DreamGame', 'SX')"--> 
                        <div class="title">
                            <p>DG</p>
                        </div>
                    ...
                    <li id="c-AS" class="c-AS" :class="{disabled : as_active == 0, enabled : as_active == 1}" @click="into_game('ASGame', 'SX')">
                        <div class="title">
                            <p>AS</p>
                        </div>
                        <div class="cover">{{ __('msg_zy_1.in_maintenance') }}</div>
