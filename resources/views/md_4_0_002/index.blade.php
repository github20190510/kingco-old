...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="INDEX">
        ...
        <div class="main game-module" id="index_data">
            ...
            <div class="content">
                <div class="games cardgame animated bounce" title="{{ __('msg_zy_1.cardgame2') }}" @click="into_game_card"></div>
                <div class="games sport animated heartBeat" title="{{ __('msg_zy_1.sport') . __('msg_zy_1.betting') }}" @click="into_game_sport"></div>
                <div class="games casino animated jello" title="{{ __('msg_zy_1.real_casino') }}" @click="into_game_casino"></div>
                <div class="games fishing animated tada" title="{{ __('msg_zy_1.fishing') . __('msg_zy_1.zone') }}" @click="into_game_fish"></div>
                <div class="games lottery animated jello" title="{{ __('msg_zy_1.lottery') . __('msg_zy_1.zone') }}" @click="into_game_lottery"></div>
                <div class="games slots animated rubberBand" title="{{ __('msg_zy_1.slots2') }}" @click="into_game_cq9"></div>
            </div>
        </div>
        <!--Main End-->
        @include($footer_name)
