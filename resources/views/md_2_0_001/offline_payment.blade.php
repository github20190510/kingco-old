                                    ...
                                    <div v-if="grepStatus == 1 " class="content">
                                        <div  class="member-name">
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-if="{{$qrtype}} == 1">{{ __('msg_dt_1.wechat') }}{{ __('msg_dt_1.qr_name') }}</label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-else>{{ __('msg_dt_1.alipay') }}{{ __('msg_dt_1.qr_name') }}</label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-if="{{$qrtype}} == 1">{{ __('msg_dt_1.wechat') }}{{ __('msg_dt_1.qr_id') }}</label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-else>{{ __('msg_dt_1.alipay') }}{{ __('msg_dt_1.qr_id') }}</label>
