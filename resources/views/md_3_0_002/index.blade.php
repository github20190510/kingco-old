                        ...
                        <div class="row">
                            <div class=" col">
                                <div class="games cardgame" @click="into_game_card">
                                    <span class="sr-only">{{ __('msg_zy_1.cardgame2') . __('msg_zy_1.zone') }}</span>
                            ...
                            <div class="col">
                                <div class="games sport" @click="into_game_sport">
                                    <span class="sr-only">{{ __('msg_zy_1.sport') . __('msg_zy_1.betting') }}</span>
                                    <span class="games-up"></span>
                                    <span class="games-out"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="games casino" @click="into_game_casino">
                                    <span class="sr-only">{{ __('msg_zy_1.real_casino') }}</span>
                                    <span class="games-up"></span>
                                    <span class="games-out"></span>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="games fishing" @click="into_game_fish">
                                    <span class="sr-only">{{ __('msg_zy_1.fishing') . __('msg_zy_1.zone') }}</span>
                                    <span class="games-up"></span>
                                    <span class="games-out"></span>
                                </div>
                            </div>
                    ...
                    <div class="col-4">
                        <div class="row">
                            ...
                            <div class="games lottery" @click="into_game_lottery">
                                <span class="sr-only">{{ __('msg_zy_1.lottery') . __('msg_zy_1.zone') }}</span>
                                <span class="games-up"></span>
                                <span class="games-out"></span>
                                </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="games slots" @click="into_game_cq9">
                                <span class="sr-only">{{ __('msg_zy_1.slots2') }}</span>
                                <span class="games-up"></span>
                                <span class="games-out"></span>
                            </div>
                        </div>
