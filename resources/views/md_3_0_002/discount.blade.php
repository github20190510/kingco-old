...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="main discount-main">
            <div class="content discount-tab">
                <!--<nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-all-tab" data-toggle="tab" href="#nav-all" role="tab" aria-controls="nav-all" aria-selected="true">{{ __('message_dt.all') }}</a>
                        <a class="nav-item nav-link" id="nav-member-tab" data-toggle="tab" href="#nav-member" role="tab" aria-controls="nav-member" aria-selected="false">{{ __('message_dt.mem_upgrade') }}</a>
                        <a class="nav-item nav-link" id="nav-events-tab" data-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false">{{ __('message_dt.special_act') }}</a>
                        <a class="nav-item nav-link" id="nav-red-tab" data-toggle="tab" href="#nav-red" role="tab" aria-controls="nav-red" aria-selected="false">{{ __('message_dt.grab_red_envelope') }}</a>
                        <a class="nav-item nav-link" id="nav-deposit-tab" data-toggle="tab" href="#nav-deposit" role="tab" aria-controls="nav-deposit" aria-selected="false">{{ __('message_dt.deposit') }}{{ __('message_dt.discount') }}</a>
                        <a class="nav-item nav-link" id="nav-pinying-tab" data-toggle="tab" href="#nav-pinying" role="tab" aria-controls="nav-pinying" aria-selected="false">{{ __('message_dt.backwater') }}{{ __('message_dt.discount') }}</a>
                    </div>
                </nav>-->
