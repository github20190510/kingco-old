                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 middle text-left mt-2">
                                <div class="user-edit-module" id="mb_edit_data">
                                    <div class="mem-title">
                                        <h5><i class="far fa-address-card"></i> {{ __('msg_zy_1.personal_inf') }}</h5>
                                    </div>
                                    <div>
                                        <div class="member-name">
                                            <!-- <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-right">{{ __('msg_zy_1.nickname') }} :</label>
                                                <div class="col-sm-9" v-if="has_nick == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputname" placeholder="{{ __('msg_zy_1.input_nickname') }}" value="" v-model="displayalias">
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-right">{{ __('msg_zy_1.real_name') }} :</label>
                                                <div class="col-sm-9" v-if="has_real_name == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputrealname" placeholder="{{ __('msg_zy_1.real_name_desc1') }}" value="" v-model="real_name">
                                                    <span class="small"><span class="text-danger">{{ __('msg_zy_1.real_name_desc2') }}</span></span>
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputphone" class="col-sm-2 col-form-label text-right"><span class="memicon phone-icon"></span>{{ __('msg_zy_1.mobile') }} :</label>
                                                <div class="col-sm-9" v-if="has_phoneno == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputphone" placeholder="{{ __('msg_zy_1.input_mobile') }}" value="" v-model="phoneno">
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputmail" class="col-sm-2 col-form-label text-right"><span class="memicon mail-icon"></span>{{ __('msg_zy_1.email') }} :</label>
                                                <div class="col-sm-9" v-if="has_email == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputmail" placeholder="{{ __('msg_zy_1.input_email') }}" value="" v-model="email">
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputqq" class="col-sm-2 col-form-label text-right"><span class="memicon qq-icon"></span>{{ __('msg_zy_1.qq') }} :</label>
                                                <div class="col-sm-9" v-if="has_qq == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputqq" placeholder="{{ __('msg_zy_1.input_qq') }}" value="" v-model="qq">
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputwechat" class="col-sm-2 col-form-label text-right"><span class="memicon wechat-icon"></span>{{ __('msg_zy_1.wechat') }} :</label>
                                                <div class="col-sm-9" v-if="has_wechat == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputwechat" placeholder="{{ __('msg_zy_1.input_wechat') }}" value="" v-model="wechat">
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputline" class="col-sm-2 col-form-label text-right"><span class="memicon"></span>{{ __('msg_zy_1.line') }} :</label>
                                                <div class="col-sm-9" v-if="has_line == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputline" placeholder="{{ __('msg_zy_1.line') }}" value="" v-model="line">
                                                </div>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputskype" class="col-sm-2 col-form-label text-right"><span class="memicon"></span>{{ __('msg_zy_1.skype') }} :</label>
                                                <div class="col-sm-9" v-if="has_skype == '0'">
                                                    <input type="text" class="form-control mem_input" id="inputskype" placeholder="{{ __('msg_zy_1.skype') }}" value="" v-model="skype">
                                                </div>
                                        ...
                                        <!--<div class="memberPhoto w-50">
                                            ...
                                            <div class="btn btn-outline-warning updataphoto">
                                                ...
                                                {{ __('msg_zy_1.sel_from_album') }}
                                            </div>
                                        </div>-->
                                    </div>
                                    <div class="savbtn text-center">
                                        <button type="button" class="btn btn-warning" @click="update_mb_data">{{ __('msg_zy_1.save') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
