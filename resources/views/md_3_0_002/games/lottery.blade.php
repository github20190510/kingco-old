    ...
    <body>
        ...
        <div class="main">
            <div class="content" id="game_list">            
                ...
                <div id="lottery_sg" class="lottery-ad lottery_sg" @click="chk_game_login('SGGame_CP')"><a href="{{ action('Game_Controller@into_game', ['gid'=>'SGGame', 'gtype'=>'CP']) }}" ref="SGGame_CP" target="_blank"><!--SG--></a></div>
