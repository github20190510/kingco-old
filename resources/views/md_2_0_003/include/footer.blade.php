<div class="container footer" id="footer">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header text-white brown">
                            <h5 class="modal-title" id="show_message_title">{{ __('msg_fcs_1.my_info') }}</h5>
                        ...
                        <div class="modal-footer">
                            <button v-if="message_count != 0" type="button" class="btn btn-lh m-auto"  @click="into_message">{{ __('msg_fcs_1.check_message') }}</button>
                            <button v-if="url == ''" type="button" class="btn btn-lh m-auto"  data-dismiss="modal">{{ __('msg_fcs_1.ok') }}</button>
                            <button v-else type="button" class="btn btn-lh m-auto"  data-dismiss="modal" @click="into_spcific_page(login_bar.url)">{{ __('msg_fcs_1.ok') }}</button>
                        </div>
                    </div>
                </div>
            </div>
            <!--login message-->
	<div class="partner_title">{{ __('msg_fcs_1.partner') }}</div>
	...
	<div class="copyright text-white text-center">
	    <p>{{ __('msg_fcs_1.copyright_desc') }}<br>
	    {{ __('msg_fcs_1.copyright') }}</p>
	</div>
</div>
<script>
    ...
    var app = new Vue({
        ...
        filters : {
            formatDate : function(value){
                ...
                var weekday = ['<?php echo __('msg_fcs_1.Sun'); ?>', '<?php echo __('msg_fcs_1.Mon'); ?>', '<?php echo __('msg_fcs_1.Tus'); ?>', '<?php echo __('msg_fcs_1.Wed'); ?>', '<?php echo __('msg_fcs_1.Thu'); ?>', '<?php echo __('msg_fcs_1.Fri'); ?>', '<?php echo __('msg_fcs_1.Sat'); ?>'];
                this.week = weekday[new Date().getDay()];
                return month + '<?php echo __('msg_fcs_1.month'); ?>' + day + '<?php echo __('msg_fcs_1.day'); ?> ' + hours + ':' + minutes + ':' + seconds + ' ' + this.week;
