        ...
        <div class="container">
            <div id="loginModal" class="login_modal">
                ...
                <div class="login_modal_header">
                    <div class="login_modal_title" id="rcDialogTitle1">{{ __('msg_fcs_1.login') }}</div>
                </div>
                <div class="login_modal_body">
                    <div class="login-form-module">
                        <div class="form-group">
                            <input name="username" autocomplete="username" class="form-control login_input" v-model="login_page_acc" ref="login_page_acc" placeholder="{{ __('msg_fcs_1.input_username') }}" type="text" value="">
                        </div>
                        <div class="form-group">
                            <input name="password" autocomplete="password" type="password" class="form-control login_input" v-model="login_page_pwd" ref="login_page_pwd" placeholder="{{ __('msg_fcs_1.input_password') }}" value="">
                        </div>
                        <div class="form-group">
                            <div class="form-check auto_login">
                                ...
                                <label class="form-check-label" for="gridCheck">{{ __('msg_fcs_1.auto_login') }}</label>
                            </div>
                        </div>
                        <div class="form-group btn_submit">
                            <button class="btn login_now_btn" v-on:click="chk_page_login">{{ __('msg_fcs_1.immediately_login') }}</button>
                        </div>
                        <div class="form-group btn_submit">
                            <button class="btn register_now_btn" onclick="location.href='{{ url('mb/register') }}'">{{ __('msg_fcs_1.register_now') }}</button>
