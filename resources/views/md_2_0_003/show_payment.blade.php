                                    ...
                                    <div v-if="grepStatus == 1 " class="content">
                                        <div v-for ="(emp_card, index) in emp_cards" class="member-name">
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" >{{ __('msg_fcs_1.bank_name') }}</label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-right" >{{ __('msg_fcs_1.acoount_name') }}</label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-right">{{ __('msg_fcs_1.open_account_name') }}</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-right">{{ __('msg_fcs_1.open_account') }}</label>
                                                <div class="col-sm-9">
