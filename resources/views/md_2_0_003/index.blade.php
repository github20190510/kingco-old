        ...
        <div class="container sun_firstPanel" id="index_data">
            ...
            <div class="content">
                <div class="notice-module d-flex align-items-center">
                    <span class="mr-2"><i class="fas fa-volume-up text-gold"></i> {{ __('msg_fcs_1.latest_news') }}</span>
            ...
            <div class="game-module-tab2">
                <div class="content">
                        ...
                        <div class="row">
                            <div class="col columns">
                                <ul class="owl-carousel owl-theme">
                                    <li v-for="v in platform" class="item" :class="v['class_name']" @click=""></li> <!--goto_game(v['act_name']) -->
                    ...
                    <div class="game-container d-flex">
                        <div class="disInline adBox" @click=""></div> <!-- into_game_fish-->
                        ...
                        <!--<div class="disInline prize">
                            <div class="prize-module ">
                                <div class="p-content">
                                    <div class="top">
                                        <div class="jackPot">
                                            <h3>{{ __('msg_fcs_1.jack_pot_desc') }}</h3>
                                            <p id="num">8790558</p>
                                        </div>
                                    </div>
                                    <div class="list">
                                        <div class="title">{{ __('msg_fcs_1.game_msater') }}</div>
                    ...
                    <div class="more">
                        <div class="text">{{ __('msg_fcs_1.index_desc') }}</div>
                        <div class="btn m-btn" @click="">MORE GAME++</div> <!--into_game_list('cq9list')-->
                    </div>
                </div>
            </div>
            <!--Slots End-->
            ...
            <div class="content2 mt-2">
                <div class="main">
                    ...
                    <div class="kind">
                        <div class="kind-item sport" @mouseover="show_img1()" @click=""></a></div> <!-- for f1 into_game_sport-->
                        <div class="kind-item casino" @mouseover="show_img2()" @click=""> </div> <!-- for f1 into_game_casino-->
                        <div class="kind-item bingo now" @click="into_game_lottery" @mouseover=""> </div> <!-- for f1 show_img3()-->
                    </div>
                    <!--此處顯示由程式控制-->
                    <div class="games">
                        <h2 class="title">{{ __('msg_fcs_1.hot_game') }} | HOT GAMES</h2>
                        <div class="items">
                            <div class="items s-item" v-if="img1_isShow === 1" @click=""></div> <!-- for f1 into_game_sport-->
                            <div class="items c-item" v-if="img2_isShow === 1" @click=""></div> <!-- for f1 into_game_casino-->
            ...
            components: {
                comCQ9 : {
                    template: '<ul class="ag-tab d-flex flex-wrap justify-content-between">' +
                        '<li><a  target="_blank">' + //for f1 href="/game/intogame/CQ9Game/1"
                        ...
                        '</a></li>' +
                        '<li><a  target="_blank">' + //for f1 href="/game/intogame/CQ9Game/7"
                        ...
                        '</a></li>' +
                        '<li><a  target="_blank">' + //for f1 href="/game/intogame/CQ9Game/16"
                        ...
                        '</a></li>' +
                        '<li><a  target="_blank">' + //for f1 href="/game/intogame/CQ9Game/18"
