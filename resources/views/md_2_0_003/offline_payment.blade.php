                        ...
                        <div class="row">
                            <div class="col-md-12 middle text-left mt-2">
                                <div class="user-edit-module" id="mb_edit_data">
                                    <div class="mem-title">
                                        <h5><i class="far fa-address-card"></i>{{ __('msg_fcs_1.complete_payment') }}</h5>
                                    </div>
                                    <div v-if="grepStatus == 1 " class="content">
                                        <div  class="member-name">
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-if="{{$qrtype}} == 1">{{ __('msg_fcs_1.wechat') }}{{ __('msg_fcs_1.qr_name') }}</label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-else>{{ __('msg_fcs_1.alipay') }}{{ __('msg_fcs_1.qr_name') }}</label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-if="{{$qrtype}} == 1">{{ __('msg_fcs_1.wechat') }}{{ __('msg_fcs_1.qr_id') }}</label>
                                                <label for="inputname" class="col-sm-2 col-form-label text-right" v-else>{{ __('msg_fcs_1.alipay') }}{{ __('msg_fcs_1.qr_id') }}</label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-right">{{ __('msg_fcs_1.saving_amount') }}</label>
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-right">{{ __('msg_fcs_1.comment') }}</label>
                                                <div class="col-sm-9">
