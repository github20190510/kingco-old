                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header text-white brown">
                            <h5 class="modal-title" id="exampleModalLabel">{{ __('msg_fcs_1.money_not_enough') }}</h5>
                        ...
                        <div class="modal-footer"> 
                            <button type="button" class="btn btn-lh m-auto" @click="trans_point_page" id="trans_point_page">{{ __('msg_fcs_1.into_point_page') }}</button>
                            <button type="button" class="btn btn-lh m-auto" @click="confirm_into_game">{{ __('msg_fcs_1.into_game') }}</button>
                            <button type="button" class="btn btn-lh m-auto" @click="auto_trans_point" id="auto_trans_point">{{ __('msg_fcs_1.auto_trans_point') }}</button>
                        </div>
                    </div>
                </div>
            </div>
