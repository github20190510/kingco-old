...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="container main casino-content-module">
            <div class="content" id="casino_game">
                <div class="casinoNav">
                    <li class="">{{ __('msg_fcs_1.OG') }}(OG)</li>
                    <li class="">{{ __('msg_fcs_1.AB') }}(AB)</li>
                    <li class="">{{ __('msg_fcs_1.AG') }}(AG)</li>
                    <li class="">{{ __('msg_fcs_1.BBIN') }}(BBIN)</li>
                </div>
                ...
                <ul class="d-flex flex-wrap justify-content-between">
                    ...
                    <li id="c-WM" class="c-WM" :class="{disabled : wm_active == 0, enabled : wm_active == 1}" @click="into_game('WMGame', 'SX')">
                        ...
                        <div class="cover">{{ __('message.in_maintenance') }}</div>
                    </li>
                    ...
                    <li id="c-AS" class="c-AS" :class="{disabled : queenco_active == 0, enabled : queenco_active == 1}" @click="into_game('ASGame', 'SX')">
                        <div class="title">
                            <p>AS</p>
                        </div>
                        <div class="cover">{{ __('msg_fcs_1.in_maintenance') }}</div>
