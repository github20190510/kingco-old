        ...
        <div id="rtglist">
            <div class="container-fluid text-center slot-nav-bar">
               ...
               <!--  <div class="slot-type d-flex align-items-center justify-content-center">
                    ...
                    <button type="button" class="btn slot-type-btn">{{ __('msg_fcs_1.prize_pool_slot_machine') }}</button>
                    ...
                    <button class="btn gb-gold text-white btn-sm ml-2" type="button" @click="search_data()">{{ __('msg_fcs_1.search') }}</button>
                </div> -->
            </div>
            <div class="container slot-main">
                <div class="game-box d-flex flex-wrap align-content-start">
                    <div class="game" :class="{'disabled': v['status'] === false, 'enabled': v['status'] === true}" v-for="(v, k) in gamedatas">
                        <div class="mask"><a :href="'/game/intogame/RTGGame/' + v['gamecode']" target="_blank"><span>{{ __('msg_fcs_1.enter') . __('msg_fcs_1.game') }}</span></a></div>
