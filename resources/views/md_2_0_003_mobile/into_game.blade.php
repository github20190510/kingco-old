    ...
    <body style="margin:0px;padding:0px;overflow:hidden;width:100%">
        <div id="game_list">
            ...
            <div class="main">
                ...
                <div v-if="alter_rotate == 1"  align="center" valign="center" style="height:100%;width:100%;color:white;font-size:30px">{{ __('msg_fcs_1.please_rotate') }}</div>
                    ...
                    .then(function (response) {
                        ...
                        if(this.json['code'] == '1'){
                            if(arr_trans_page_game.indexOf(self.$refs.dt2.value) == '-1'){
                                ...
                                if (self.$refs.dt2.value == "ASGame" || self.$refs.dt2.value == "WMGame" || (self.$refs.dt2.value == "GenesisGame" && isiOS)){
