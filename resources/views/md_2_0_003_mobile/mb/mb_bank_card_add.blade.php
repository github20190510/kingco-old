                ...
                <form class="needs-validation" novalidate onSubmit="return false;">                    
                    <div class="input-group register-input dropdown-box">
                        <div class="input-group-prepend dropdown-left">
                            <label class="input-group-text c-alpha-gold text-white border-0" for="inputGroupSelect01"><i class="fas fa-university fa-fw mr-1"></i> {{ __('msg_fcs_1.new_back') }}</label>
                        </div>
                        <!--<div class="input-group-append dropdown-right">
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="btn_bank">{{__('msg_fcs_1.sel_bank')}}</button>
                        ...
                        <select class="custom-select bank-select" id="inputGroupSelect01" v-model="bankno">
                            <option value="nodata" class="text-center">{{__('msg_fcs_1.sel_bank')}}...</option>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            ...
                            <label type="text" class="form-control border-left-0 bg-transparent" id="nameAccount" placeholder="{{ __('msg_fcs_1.input_acc_name') }}" v-if="whether_card_change == 0" style="color: white">@{{mb_head.nick_name}}</label>
                            <input type="text" class="form-control border-left-0 bg-transparent" id="nameAccount" placeholder="{{ __('msg_fcs_1.input_acc_name') }}" v-if="whether_card_change == 1">
                        <div class="invalid-feedback">
                                {{ __('msg_fcs_1.input_acc_name') }}
                        </div>
                    </div>
                    <div class="input-group register-input">
                        <div class="input-group-append">
                        ...
                        <input type="text" class="form-control border-left-0 bg-transparent" id="bankid" placeholder="{{ __('msg_fcs_1.openning_bank_name') }}：{{ __('msg_fcs_1.input_openning_bank_name') }}" required v-model="openning_bank">
                        <div class="invalid-feedback">
                                {{ __('msg_fcs_1.input_openning_bank_name') }}
                        </div>
                    </div>
                    <div class="input-group register-input">
                        <div class="input-group-append">
                        ...
                        <input type="text" class="form-control border-left-0 bg-transparent" id="bankid" placeholder="{{ __('msg_fcs_1.bank_card_no') }}：{{ __('msg_fcs_1.input_bank_card_no') }}" required v-model="mb_cardno">
                        <div class="invalid-feedback">
                                {{ __('msg_fcs_1.input_bank_card_no') }}
                        </div>
                    </div>
                    ...
                    <div class="input-group register-input">
                        ...
                        <input type="password" class="form-control border-left-0 bg-transparent" id="password" placeholder="{{ __('msg_fcs_1.pay_pass') }}：{{ __('msg_fcs_1.input_pay_pass') }}" required v-model="mb_paypwd">
                        <div class="invalid-feedback">
                                {{ __('msg_fcs_1.input_pay_pass') }}
                        </div>
                    </div>
                    <button type="submit" class="btn btn-danger btn-block c-alpha-gold bank-btn" @click="save_card_data">{{ __('msg_fcs_1.save_bank_card') }}</button>
                </form>
            </main>
        </div>
        <!--go to top-->
            ...
            methods: {
                ...
                save_card_data: function(){
                    ...
                    .then(function (response) {
                        this.json = response.data;
                        if(this.json['code'] == '1'){
                            self.alertinfo('<?php echo __("msg_fcs_1.insert_succ"); ?>', '/mb/bank_card');
                        }else{
