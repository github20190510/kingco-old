            ...
            <main role="main" class="container main bank-main">
                ...
                <section class="funds-table mb-3" v-if="bln_has_save_data == 1" v-for="savedata in savedatas">
                    <div class="row funds-date">
                        <div class="col">{{ __('msg_fcs_1.date') }} : <span>@{{savedata.orderdate}}</span></div>
                    </div>
                    <div class="row funds-2">
                        <div class="col">{{ __('msg_fcs_1.order_no') }} : <strong class="text-warning">@{{savedata.ordernumber}}</strong></div>
                    </div>
                    <div class="row funds-2">
                        <div class="col-6">{{ __('msg_fcs_1.amount') }} : <strong class="text-warning">@{{ formatMoney(savedata.orderamount) }}</strong></div>
                        <div class="col-6">{{ __('msg_fcs_1.status') }} : <span>@{{savedata.str_status}}</span></div>
                    </div>
                </section>
