        ...
        <div id="mb_bankcards">
            <main role="main" class="container main bank-main">
                <section class="d-flex flex-wrap justify-content-around">
                    <div class="add-card">
                        <button type="button" class="btn d-flex align-items-center flex-column justify-content-center" onclick="location.href='/mb/bank_card_add'"><i class="far fa-plus-square"></i>{{ __('msg_fcs_1.add_bank_card_mobile') }}</button>
                    </div>
                    <div class="new-card c-alpha-gold enabled" v-for="card_data in card_datas">
                        ...
                        <div class="edit-bar d-flex justify-content-center">
                            ...
                            <span class="btn btn-sm default" v-if="card_data.status == 1 && card_data.infomationcomment == ''" @click="set_default(card_data.informationcode)">{{ __('msg_fcs_1.set_preset') }}</span>
                        </div>
                        <div class="use-card" v-if="card_data.infomationcomment == '<?php echo __("msg_fcs_1.default"); ?>'"><span></span><!--預設卡--></div>
                    </div>
                </section>
            </main>
        </div>
