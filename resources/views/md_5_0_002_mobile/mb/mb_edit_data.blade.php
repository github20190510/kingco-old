        ...
        <div id="mb_edit_data">
            <header class="login-header navbar-dark">
                <div class="d-flex align-items-center">
                    ...
                    <div class="header-title m-auto">{{ __('msg_zy_1.personal_inf') }}</div>
                </div>
            </header>
                ...
                <form class="needs-validation" novalidate onSubmit="return false;">
                    ...
                    <!-- <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-user fa-fw mr-1"></i> <span class="input-title">{{ __('msg_zy_1.nickname') }} : </span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-passport fa-fw mr-1"></i> <span class="input-title">{{ __('msg_zy_1.real_name') }} :</span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-mobile-alt fa-fw mr-1"></i><span class="input-title">{{ __('msg_zy_1.mobile') }} :</span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="far fa-envelope fa-fw mr-1"></i><span class="input-title">{{ __('msg_zy_1.email') }} :</span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fab fa-qq fa-fw mr-1"></i><span class="input-title">{{ __('msg_zy_1.qq') }} :</span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fab fa-weixin fa-fw mr-1"></i><span class="input-title">{{ __('msg_zy_1.wechat') }} :</span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fab fa-line fa-fw mr-1"></i><span class="input-title">{{ __('msg_zy_1.line') }} :</span></span>
                        </div>
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fab fa-skype fa-fw mr-1"></i><span class="input-title">{{ __('msg_zy_1.skype') }} :</span></span>
                        </div>
