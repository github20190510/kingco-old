	...
	<body class="main-body main-register">
		...
		<header class="login-header navbar-dark">
			<div class="d-flex align-items-center">
				...
				<div class="header-title m-auto">{{ __('msg_zy_1.mb_register') }}</div>
			</div>
		</header>
		<main role="main" class="container main register-main" id="register">
			<form class="needs-validation" novalidate onSubmit="return false;">
				...
				<button type="submit" class="btn btn-danger btn-block c-alpha-gold border-0 register-btn" @click.stop="chk_login">{{ __('msg_zy_1.register_now2') }}</button>
