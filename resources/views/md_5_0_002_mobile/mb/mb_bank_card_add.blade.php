        ...
        <div id="mb_bankcards">
            <header class="login-header navbar-dark">
                <div class="d-flex align-items-center">
                    ...
                    <div class="header-title m-auto">{{ __('msg_zy_1.add_bank_card_mobile') }}</div>
                </div>
            </header>
                ...
                <form class="needs-validation" novalidate onSubmit="return false;">                    
                    ...
                    <div class="input-group register-input">
                        <div class="input-group-append">
                            ...
                            <label type="text" class="form-control border-left-0 bg-transparent" id="nameAccount" placeholder="{{ __('msg_zy_1.input_acc_name') }}" v-if="whether_card_change == 0" style="color: black">@{{login_bar.nick_name}}</label>
        ...
        var mb_bankcards = new Vue({
            ...
            methods: {
                ...
                save_card_data: function(){
                    ...
                    var ApiURL = API_Host + '/mb/addubankcard/' + this.mb_cardno + '/' + login_bar.nick_name + '/' + this.openning_bank + '/' + this.bankno + '/' + this.mb_paypwd;
                    Vue.prototype.$http = axios;
