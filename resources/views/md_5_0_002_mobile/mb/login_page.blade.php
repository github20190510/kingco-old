        ...
        <main role="main" class="container main register-main" id="login">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content c-alpha-white  border-0">
                        <div class="modal-header text-white c-gold border-0">
                            <h6 class="modal-title" id="show_message_title">{{ __('msg_zy_1.my_info') }}</h6>
                        ...
                        <div class="modal-footer border-0"> 
                            <button v-if="message_count != 0" type="button" class="btn btn-lh m-auto btn-dark c-gold border-0"  @click="into_message">{{ __('msg_zy_1.check_message') }}</button>
                            <button type="button" class="btn btn-lh m-auto btn-dark c-gold border-0"  @click="into_home">{{ __('msg_zy_1.ok') }}</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="needs-validation" novalidate onSubmit="return false;">
                <div class="input-group register-input">
                    ...
                    <input type="text" class="form-control border-left-0 bg-transparent" id="account" placeholder="{{ __('msg_zy_1.input_username') }}" v-model="login_page_acc" ref="login_page_acc" required v-focus>
                    <div class="invalid-feedback">{{ __('msg_zy_1.input_username') }}</div>
                </div>                
                <div class="input-group register-input">
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                    </div>
                    <input type="password" class="form-control border-left-0 bg-transparent" id="password" placeholder="{{ __('msg_zy_1.input_password') }}" v-model="login_page_pwd" ref="login_page_pwd" required>
                    <div class="invalid-feedback">{{ __('msg_zy_1.input_password') }}</div>
                </div> 
                <div class="input-group register-input">
                    <div class="input-group-append">
                ...
                <button type="submit" class="btn btn-danger btn-block c-alpha-gold register-btn" @click="chk_page_login">{{ __('msg_zy_1.login_mobile') }}</button>
                <div class="btn-group btn-block mt-3 new-user" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-danger w-50 c-alpha-gold register-btn" @click="goto_register">{{ __('msg_zy_1.register_now_mobile') }}</button>
                    <button type="button" class="btn btn-danger w-50 c-alpha-gold register-btn ml-2 border-radius-r" @click="alert_forgetpwd">{{ __('msg_zy_1.forget_pwd') }}</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content c-alpha-white border-0">
                            ...
                            <div class="modal-footer"> 
                                ...
                                <button type="button" class="btn border-0 btn-dark c-gold" @click="auto_trans_point" id="auto_trans_point">{{ __('msg_zy_1.auto_trans_point') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
