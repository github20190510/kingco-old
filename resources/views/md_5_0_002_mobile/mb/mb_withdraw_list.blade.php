        ...
        <div id="withdraw_list">
            <header class="login-header navbar-dark">
                <div class="d-flex align-items-center">
                    ...
                    <div class="header-title m-auto">{{ trans_choice('msg_zy_1.withdraw', 1) . __('msg_zy_1.record') }}</div>
                </div>
            </header>
            <main role="main" class="container main bank-main">
                ...
                <section class="funds-table mb-3" v-if="bln_has_take_data == 1" v-for="takedata in takedatas">
                    <div class="row funds-date">
                        <div class="col">{{ __('msg_zy_1.date') }} : <span>@{{takedata.orderdate}}</span></div>
                    </div>
                    <div class="row funds-2">
                        <div class="col">{{ __('msg_zy_1.order_no') }} : <strong class="text-warning">@{{takedata.ordernumber}}</strong></div>
                    </div>
                    <div class="row funds-2">
                        <div class="col-6">{{ __('msg_zy_1.amount') }} : <strong class="text-danger">@{{ formatMoney(takedata.orderamount )}}</strong></div>
                        <div class="col-6 text-right">{{ __('msg_zy_1.status') }} : <span class="text-success">@{{takedata.str_status}}</span></div>
                    </div>
                </section>
