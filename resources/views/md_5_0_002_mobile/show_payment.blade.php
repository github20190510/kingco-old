                        ...
                        <div class="row">
                            <div class="col-md-12 middle text-left mt-2">
                                <div class="user-edit-module" id="mb_edit_data">
                                    <div class="mem-title">
                                        <h5 style="color:#C29C61"><i class="far fa-address-card" ></i>{{ __('msg_zy_1.complete_payment') }}</h5>
                                    </div>
                                    <div v-if="grepStatus == 1 " class="content" style="color:#FFF">
                                        <div v-for ="(emp_card, index) in emp_cards" class="member-name">
                                            <div class="form-group form-row">
                                                <label for="inputname" class="col-sm-2 col-form-label text-left" >{{ __('msg_zy_1.bank_name') }} : @{{emp_card.bankname}}
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left" >{{ __('msg_zy_1.acoount_name') }} : @{{emp_card.accountname}}
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left" >{{ __('msg_zy_1.bank_account') }} : @{{emp_card.openningaccount}}
                                            ...
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_zy_1.saving_amount') }} : @{{amount}}</label>
                                                
                                            </div>
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_zy_1.open_account_name') }}</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control mem_input" id="inputrealname" placeholder="{{ __('msg_zy_1.real_name_desc1') }}" value="" v-model="openAccountName">
                                                </div>
                                            </div>
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_zy_1.open_account') }}</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control mem_input" id="inputrealname" placeholder="{{ __('msg_zy_1.real_account_desc') }}" value="" v-model="openAccount">
                                                </div>
                                            </div>
                                            <div class="form-group form-row">
                                                <label for="inputrealname" class="col-sm-2 col-form-label text-left">{{ __('msg_zy_1.comment') }}</label>
                                                <div class="col-sm-9">
                                    ...
                                    <div v-if="grepStatus == 1 " class="savbtn text-center">
                                        <button type="button" class="btn btn-warning" v-on:click="send_data">{{ __('msg_zy_1.save') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            methods: {
                ...
                check_send_data:function(){
                    ...
                    if (this.openAccount.replace(/\s/g, '').length < 5){
                        this.alertinfo('<?php echo __("msg_zy_1.openAccount_length_error"); ?>');
                        return ;
                    }
                    return true;
                },
