...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="main">
            <div class="content" id="game_list">            
                ...
                <div id="lottery_vr" class="lottery-ad lottery_vr" @click="chk_game_login('VRGame_CP')"><a href="{{ action('Game_Controller@into_game', ['gid'=>'VRGame', 'gtype'=>'CP']) }}" ref="VRGame_CP" target="_blank"></a></div><!--VR-->

                <div id="lottery_lixin" class="lottery-ad lottery_lixin" @click="chk_game_login('LXGame_CP')"><a href="{{ action('Game_Controller@into_game', ['gid'=>'LXGame', 'gtype'=>'CP']) }}" ref="LXGame_CP" target="_blank"></a></div><!--利鑫-->
