            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-md">
                        <div class="row">
                            <div class="col-md">
                                <h1>{{ __('msg_dt_1.app_title1') }} <br>{{ __('msg_dt_1.app_title2') }}</h1>
                                <p>{{ __('msg_dt_1.app_desc1') }}<br>
                                    {{ __('msg_dt_1.app_desc2') }}</p>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-md">
                ...
                <div class="row mt-5">
                    <div class="col-md safety-text">
                        <h1>{{ __('msg_dt_1.app_title3') }}<br>{{ __('msg_dt_1.app_title4') }}</h1>
                        <p>{{ __('msg_dt_1.app_desc3') }}<br>
                            {{ __('msg_dt_1.app_desc4') }}<br>
                            {{ __('msg_dt_1.app_desc5') }}</p>
                    </div>
