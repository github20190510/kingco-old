...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="container sun_firstPanel" id="index_data">
            ...
            <div class="content">
                <div class="notice-module d-flex align-items-center">
                    <span class="mr-2"><i class="fas fa-volume-up text-gold"></i> {{ __('msg_zy_1.latest_news') }}</span>
            ...
            <div class="game-module-tab2">
                <div class="content">
                        ...
                        <!--<div class="disInline prize">
                            <div class="prize-module ">
                                <div class="p-content">
                                    <div class="top">
                                        <div class="jackPot">
                                            <h3>{{ __('msg_zy_1.jack_pot_desc') }}</h3>
                                            <p id="num">8790558</p>
                                        </div>
                                    </div>
                                    <div class="list">
                                        <div class="title">{{ __('msg_zy_1.game_msater') }}</div>
                    ...
                    <div class="more">
                        <div class="text">{{ __('msg_zy_1.index_desc') }}</div>
            ...
            <div class="content2 mt-2">
                <div class="main">
                    ...
                    <!--此處顯示由程式控制-->
                    <div class="games">
                        <h2 class="title">{{ __('msg_zy_1.hot_game') }} | HOT GAMES</h2>
                        <div class="items">
        ...
        <!--Main End-->
        @include($footer_name)
        <div id="affixBox" style="display:none" class="affix-module text-white" v-if="show_box === 1">
            <div class="aff-inner">
