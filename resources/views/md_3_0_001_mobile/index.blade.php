...
<html lang="{{ app()->getLocale() }}">
        ...
        <main role="main" class="main container-fluid index-main" id="game_list">
            ...
            <section class="game-main">
                ...
                <div class="bg-transparent d-flex flex-wrap justify-content-between">
                    <!--真人-->
                    <button class="btn game-banner game-casino" type="button" @click="close_all_game('collapseCasino')"></button>
                    <!--彩票-->
                    <button class="btn game-banner game-lottery" type="button" @click="close_all_game('collapseLottery')"></button>
                </div>
                

                <!--真人遊戲-->
                <div class="collapse" id="collapseCasino" data-parent="#collapseCasino">
                ...
                <!--彩票遊戲-->
                <div class="collapse" id="collapseLottery" data-parent="#collapseLottery">
                    <ul class="game-module d-flex flex-wrap align-content-center">
            ...
            <section class="game-main">
                ...
                <div class="bg-transparent d-flex flex-wrap justify-content-between">
                    <!--電子-->
                    <button class="btn game-banner game-slot" type="button" @click="close_all_game('collapseSlot')"></button>
                    
                    <!--體育-->
                    <button class="btn game-banner game-sport" type="button" @click="close_all_game('collapseSport')"></button>
                </div>
                <!--電子遊戲-->
                <div class="collapse" id="collapseSlot" data-parent="#collapseSlot">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                ...
                <!--體育遊戲-->
                <div class="collapse" id="collapseSport" data-parent="#collapseSport">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                        ...
                        <li class="game-logo logo-bl" @click="trans_into_game('BLinkGame', 'TY')"></li>
            ...
            <section class="game-main">
                <div class="bg-transparent d-flex flex-wrap justify-content-between">
                    <!--釣魚-->
                    <button class="btn game-banner game-fishing" type="button" @click="close_all_game('collapseFishing')"></button>
                    <!--棋牌-->
                    <button class="btn game-banner game-card" type="button" @click="close_all_game('collapseCard')"></button>
                </div>
                <!--釣魚遊戲-->
                <div class="collapse" id="collapseFishing" data-parent="#collapseFishing">
                    <ul class="game-module d-flex flex-wrap align-content-center">
                ...
                <!--棋牌遊戲-->
                <div class="collapse" id="collapseCard" data-parent="#collapseCard">
                    <ul class="game-module d-flex flex-wrap align-content-center">
            ...
            <section class="game-main">
                <div class="bg-transparent d-flex flex-wrap justify-content-between">
                    <!--其他遊戲-->
                    <button class="btn game-banner game-other" type="button"></button>
                    <!--影城-->
                    <button class="btn game-banner game-movie" type="button" @click="into_movie"></button>
                </div>                
            </section>
    ...
    <script>
        ...
        var game_list = new Vue({
            ...
            methods: {
                into_movie: function(){
                    if (menu.login_status == '1'){
                        window.open("http://av.dtg1688.net/");
                    }else{
