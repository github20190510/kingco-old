    ...
    <body class="main-body">    
        <header class="login-header c-purple fixed-top">
            <div class="d-flex align-items-center">
                ...
                <div class="header-title">{{ __('msg_dt_1.mb_register') }}</div>
            </div>
        </header>
            ...
            <form class="needs-validation" novalidate onSubmit="return false;">                
                <div class="input-group register-input">
                    <div class="input-group-append">
                     ...
                     <input type="text" class="form-control border-left-0 bg-transparent" id="account" placeholder="{{ __('msg_dt_1.input_mb_acc') }}" required v-focus ref="userid" v-model="userid">
                    <div class="invalid-feedback">
                            {{ __('msg_dt_1.input_mb_acc') }}
                    </div>
                </div>  
                <div class="input-group register-input">
                    <div class="input-group-append">
                     ...
                     <input type="text" class="form-control border-left-0 bg-transparent" id="alias" placeholder="{{ __('msg_dt_1.real_name') }}" required v-focus ref="alias" v-model="alias">
                    <div class="invalid-feedback" style="display: inline">
                            {{ __('msg_dt_1.input_real_name') }}
                    </div>
                </div>  
                <div class="input-group register-input">
                    <div class="input-group-append">
                    ...
                    <input type="password" class="form-control border-left-0 bg-transparent" id="password" placeholder="{{ __('msg_dt_1.input_login_pwd') }}" required ref="pwd" v-model="pwd">
                    <div class="invalid-feedback">
                            {{ __('msg_dt_1.input_login_pwd') }}
                    </div>
                </div>                
                <div class="input-group register-input">
                    <div class="input-group-append">
                    ...
                    <input type="password" class="form-control border-left-0 bg-transparent" id="password-confirm" placeholder="{{ __('msg_dt_1.again_pwd') }}" required ref="chkpwd" v-model="chkpwd">
                    <div class="invalid-feedback">
                            {{ __('msg_dt_1.again_pwd') }}
                    </div>
                </div>
                <div class="input-group register-input">
                    <div class="input-group-append">
                    ...
                    <div class="input-group-append code-img-box">
                        <span class="code-img" style="background-color:transparent; ">
                            <img ref="verifycode" src="{{captcha_src()}}" onclick="this.src='{{captcha_src()}}'+Math.random()" id="verifycode" class="border-0 m-0">
                            <i class="fas fa-sync ml-2" onclick="click_img()"></i>
                        </span>
                    </div>
                    <div class="invalid-feedback">{{ __('msg_dt_1.captcha_empty_err') }}</div>
                </div>
                <button type="submit" class="btn btn-danger btn-block c-alpha-gold register-btn" @click.stop="chk_login">{{ __('msg_dt_1.register_now2') }}</button>
                <div class="text-center mt-3">
                    <label class="checkbox-group">{{ __('msg_dt_1.agree_agreement_mobile') }}
