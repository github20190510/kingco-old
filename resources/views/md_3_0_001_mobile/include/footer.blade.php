<nav class="btn-group d-flex fixed-bottom c-alpha-grey align-items-center footer-menu" role="group">
    ...
    <button type="button" class="btn btn-sm bg-transparent d-flex flex-column align-items-center p-0 w-100 f-btn" role="button"><span class="f-icon favorite-btn"></span><span>{{ __('msg_dt_1.my_favorite') }}</span></button>
